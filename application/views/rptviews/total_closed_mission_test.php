...
var fields = [
  ...
  $(document).ready(function() {
    ...
    setupPivot({url:"<?php echo base_url('resources/lib/csv/usc_tmr.csv'); ?>", fields: fields, filters: {employer: 'Acme Corp'}, rowLabels:["city"], summaries:["billed_amount", "payment_amount"]})
